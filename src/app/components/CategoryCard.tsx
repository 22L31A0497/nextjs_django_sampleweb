...
export default function CategoryCard({ categoryDescription, categoryImage, categoryName, categorySlug, _id }: CategoryData) {
    ...
    return (
        <div onClick={() => router.push(`/category/category-product/${encodeURIComponent(categoryName)}`)} className="card card-compact text-black cursor-pointer m-3 w-80 bg-gray-50 shadow-xl relative">
